...
public class EditActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    String loadUrl = "http://192.168.56.1/PhpProject1/ws/loadEtudiant.php";
    String updateUrl="http://192.168.56.1/PhpProject1/ws/updateEtudiant.php";
                ...
                loadUrl, response -> {
                    ...
                    for(Etudiant e : etudiants) {
                        if(e.getId() == id) {
                            ...
                            }else if(e.getVille().equals("youssoufia")) {
        ...
        if (view == update) {
            ...
            StringRequest request = new StringRequest(Request.Method.POST,
                    updateUrl, response -> {
                        ...
                        startActivity(new Intent(EditActivity.this, ListEtudiantActivity.class));
                    }, error -> Toast.makeText(EditActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show()) {
                @Override
                protected Map<String, String> getParams() throws AuthFailureError {
                    String sexe = "";
